...
public class VistaPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        listaAOcultos = new javax.swing.JList();
        ...
        listaAOcultos.addListSelectionListener(new javax.swing.event.ListSelectionListener() {
            public void valueChanged(javax.swing.event.ListSelectionEvent evt) {
                listaAOcultosValueChanged(evt);
            }
        });
        jScrollPane3.setViewportView(listaAOcultos);
    ...
    public void listarArchivos(String rutaTexto){
        ...
        listaDirectorios.setModel(direc);
        arch = new DefaultListModel();
        listaArchivos.setModel(arch);
        oculto = new DefaultListModel();
        listaAOcultos.setModel(oculto);
    ...
    private void listaAOcultosValueChanged(javax.swing.event.ListSelectionEvent evt) {//GEN-FIRST:event_listaAOcultosValueChanged
        
        String elementoSeleccionado = (String) listaAOcultos.getSelectedValue();
        String rutaSeleccionada = txtRuta.getText().trim() + "\\" + elementoSeleccionado;
        mostrarInformacionArchivoSeleccionado(rutaSeleccionada);
        
        listaArchivos.clearSelection();
        listaDirectorios.clearSelection();
    }//GEN-LAST:event_listaAOcultosValueChanged
    ...
    private void menuItemRenombrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menuItemRenombrarActionPerformed
        ...
        if(!listaArchivos.isSelectionEmpty()){
            ...
            archivoSeleccionado = (String) listaAOcultos.getSelectedValue();
        }
    ...
    private void menuItemEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menuItemEliminarActionPerformed
        ...
        if(!listaArchivos.isSelectionEmpty()){
            ...
            archivoSeleccionado = (String) listaDirectorios.getSelectedValue();
        }else if(!listaAOcultos.isSelectionEmpty()){
            archivoSeleccionado = (String) listaAOcultos.getSelectedValue();
        }else {
            isValid = false;
...
private void deleteFolder(File file) {
    ...
    private void listaDirectoriosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_listaDirectoriosMouseClicked
        ...
        if(evt.getClickCount()==2){
            String ruta=txtRuta.getText().trim()+"\\"+listaDirectorios.getSelectedValue();
...
public void listarFicherosPorCarpeta(final File carpeta) {
    ...
    public void mostrarInformacionArchivoSeleccionado(String rutaSeleccionada) {
        ...
        long tamanoEnKBytes = tamanoEnBytes / 1024;
    ...
    private javax.swing.JList listaAOcultos;
